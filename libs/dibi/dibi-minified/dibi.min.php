...
new
Exception('dibi needs PHP 5.2.0 or newer.');}@set_magic_quotes_runtime(FALSE);if(interface_exists('Nette\\IDebugPanel',FALSE)){class_alias('Nette\\IDebugPanel','IDebugPanel');}elseif(!interface_exists('IDebugPanel',FALSE)){interface
...
REVISION='c052582 released on 2010-09-15';const
